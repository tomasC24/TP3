El codigo implementa un modelo de transferencia en régimen transitorio. Utiliza una matriz de masa lumpeada en el método EulerForward y una matriz de masa consistente en el EulerBackward. 
